...
def Beep(duration=.1, frequency=3000):
    ...
    try:
        os.system('play --no-show-progress --null -t alsa --channels 1 synth %s sine %f' %
                  (duration, frequency))
    except:
        pass
...
def author():
    ...
    screen.addstr(4, 18, '  _____                  _                ',
                  curses.color_pair(14) | curses.A_BOLD)
    screen.addstr(5, 18, ' / ____|                (_)               ',
                  curses.color_pair(14) | curses.A_BOLD)
    screen.addstr(6, 18, '| |  __    ___   _ __    _   _   _   ___  ',
                  curses.color_pair(14) | curses.A_BOLD)
    screen.addstr(7, 18, '| | |_ |  / _ \ | \'_ \  | | | | | | / __|',
                  curses.color_pair(14) | curses.A_BOLD)
    screen.addstr(8, 18, '| |__| | |  __/ | | | | | | | |_| | \__ \\',
                  curses.color_pair(14) | curses.A_BOLD)
    screen.addstr(9, 18, ' \_____|  \___| |_| |_| |_|  \__,_| |___/ ',
                  curses.color_pair(14) | curses.A_BOLD)

    screen.addstr(11, 20, '__   __           __         _   __  ',
                  curses.color_pair(14) | curses.A_BOLD)
    screen.addstr(12, 20, '\ \ / /__ _ _ ___ __ _ ___  / | /  \ ',
                  curses.color_pair(14) | curses.A_BOLD)
    screen.addstr(13, 20, ' \ V / -_) \'_(_-</ _` / _ \ | || () |',
                  curses.color_pair(14) | curses.A_BOLD)
    screen.addstr(14, 20, '  \_/\___|_| /__/\__,_\___/ |_(_)__/ ',
                  curses.color_pair(14) | curses.A_BOLD)

    screen.addstr(
        17, 15, 'author: Víctor Donola Ferreira (vdonoladev)', curses.color_pair(12))
...
def inkey():
    ...
    while True:
        ...
        if key in (K_ESC, K_CTRL_Q, ord('q'), ord('Q')):
            # closes the program
            screen.addstr(23, 1, 'Game aborted ...       ',
...
def showButton(n, cor=0):
    # Draw the button
    button = {1: (4, 4, 10, 24), 2: (4, 26, 10, 46),
              3: (12, 4, 18, 24), 4: (12, 26, 18, 46)}
...
def main():
    msg = {1: 'Green button   ', 2: 'Yellow button ',
           3: 'Red button', 4: 'Blue button    '}
    ...
    while True:
        ...
        # Clear the Status Bar
        screen.addstr(23, 0, c_032 * 80, curses.color_pair(13))
        screen.addstr(23, 61, 'Dificuldade: %5i ' %
                      dificuldade, curses.color_pair(13) | curses.A_BOLD)
        pause(1)
        ...
        while True:
            ...
            if button == 0:
                ...
                screen.addstr(23, 1, 'Hit something to leave ...',
                              curses.color_pair(13) | curses.A_BOLD)
        ...
        # of a time simulating the CLIPPER inkey function (<time>)
                ...
                while True:
                    ...
                    if key != -1:
                        break
                    # The screen is flashing (changing color)
                    curses.init_pair(14, random.randint(
                        0, 7), curses.COLOR_WHITE)
                    screen.refresh()
                ...
                if seq_user == seq_pc:
                    ...
                    screen.addstr(
                        11, 25, 'Congratulations!!! You got it...', curses.color_pair(12))
                    screen.addstr(
                        13, 25, 'Want to Play Again? (Y / N)', curses.color_pair(12))
                    pause(.01)
                    key = screen.getch()
                    ...
                    if len(seq_user) == dificuldade:
                        screen.addstr(23, 16, 'OK  Next level...',
                                      curses.color_pair(13) | curses.A_BOLD)
                        pause(2)
                        seq_user = ''
                        dificuldade += 1
                        ...
                        screen.addstr(
                            23, 16, 'OK', curses.color_pair(13) | curses.A_BOLD)
                        pause(.05)
                    ...
                    Beep(.2, 2200)
                    screen.addstr(
                        23, 16, 'NOK', curses.color_pair(13) | curses.A_BOLD)
                    Box.Shadow(9, 23, 15, 55, 15)

                    screen.addstr(11, 26, 'You missed ...',
                                  curses.color_pair(15) | curses.A_BLINK)
                    screen.addstr(
                        13, 26, 'Want to Play Again? (Y / N)', curses.color_pair(12))
                    pause(.01)
                    key = screen.getch()
